...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" EXCEPTION_HANDLING="NO" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
endmodule //FP_MUL_altfp_mult_ago
//VALID FILE
...
module FP_MUL (
	...
	FP_MUL_altfp_mult_ago	FP_MUL_altfp_mult_ago_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL FP_MUL_bb.v FALSE TRUE
