...
module  FP_DIV_altfp_div_pst_lme
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		value_zero_w = {9{1'b0}};
endmodule //FP_DIV_altfp_div_pst_lme

//synthesis_resources = altsyncram 1 lpm_add_sub 4 lpm_compare 1 lpm_mult 5 mux21 74 reg 339 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_DIV_altfp_div_m0i
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	FP_DIV_altfp_div_pst_lme   altfp_div_pst1
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		aclr = 1'b0,
		result = wire_altfp_div_pst1_result;
endmodule //FP_DIV_altfp_div_m0i
//VALID FILE
...
module FP_DIV (
	...
	FP_DIV_altfp_div_m0i	FP_DIV_altfp_div_m0i_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
